...
#endif
{
	inline CntValProxy::CntValProxy() :
		m_data(Internal::make_unique<NullType>())
	{}

	inline CntValProxy::CntValProxy(BoolType&& val) :
		m_data(Internal::make_unique<BoolType>(std::forward<BoolType>(val)))
	{}

	inline CntValProxy::CntValProxy(ArrayType&& val) :
		m_data(Internal::make_unique<ArrayType>(std::forward<ArrayType>(val)))
	{}
